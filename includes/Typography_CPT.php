...
class Typography_CPT {
    ...
    public static function register_cpt() {
        $labels = array(
            'name'                  => _x( 'Typography Systems', 'Post Type General Name', 'typographysystem' ),
            'singular_name'         => _x( 'Typography System', 'Post Type Singular Name', 'typographysystem' ),
            'menu_name'             => __( 'Typography Systems', 'typographysystem' ),
            'name_admin_bar'        => __( 'Typography System', 'typographysystem' ),
            'archives'              => __( 'Typography System Archives', 'typographysystem' ),
            'attributes'            => __( 'Typography System Attributes', 'typographysystem' ),
            'all_items'             => __( 'All Typography Systems', 'typographysystem' ),
            'add_new_item'          => __( 'Add New Typography System', 'typographysystem' ),
            'add_new'               => __( 'Add New', 'typographysystem' ),
            'new_item'              => __( 'New Typography System', 'typographysystem' ),
            'edit_item'             => __( 'Edit Typography System', 'typographysystem' ),
            'update_item'           => __( 'Update Typography System', 'typographysystem' ),
            'view_item'             => __( 'View Typography System', 'typographysystem' ),
            'view_items'            => __( 'View Typography Systems', 'typographysystem' ),
            'search_items'          => __( 'Search Typography System', 'typographysystem' ),
        ...
        $args = array(
            ...
            'taxonomies'            => array( 'typography_category' ),
        );
