...
const ColorSwitcher = ({
  ...
  return (
    <PanelBody title={__("Color Settings", "rrze-designsystem")}>
      <ColorPalette
        colors={colorData}
        value={value}
...
const ColorSwitcherToolbar = ({
  ...
  let classLabel = `lukasnieblerElementsBFakColorSelector`;
  if (attributes.color) {
    classLabel = hex
      ? `lukasnieblerElementsBFakColorSelector ${attributes.color.slice(1)}`
      : `lukasnieblerElementsBFakColorSelector ${attributes.color}`;
  }
      ...
      <ToolbarItem>
        {() => (
          <ToolbarDropdownMenu
            ...
            label={__("Select a Color", "rrze-designsystem")}
...
const BorderColorPicker = ({
  ...
  return (
    <PanelBody
      title={__("Border Settings", "rrze-designsystem")}
      initialOpen={false}
    >
...
const standardColorData = [
  {
    color: "#04316A",
    slug: "",
    name: __("Central institution", "rrze-designsystem"),
  },
  {
    color: "#C50F3C",
    slug: "rw",
    name: __("Faculty of Business, Economics, and Law", "rrze-designsystem"),
  },
  {
    color: "#7bb725",
    slug: "nat",
    name: __("Faculty of Sciences", "rrze-designsystem"),
  },
  {
    color: "#18B4F1",
    slug: "med",
    name: __("Faculty of Medicine", "rrze-designsystem"),
  },
  {
    color: "#FDB735",
    slug: "phil",
  ...
  },
  {
    color: "#8C9FB1",
    slug: "tf",
    name: __("Faculty of Engineering", "rrze-designsystem"),
  },
];
...
const extendedColorData: { color: string; slug: string; name: string }[] = [
  {
    color: "#fff",
    slug: "inherit",
    name: __("Inherit color", "rrze-designsystem"),
  },
  ...standardColorData,
];
